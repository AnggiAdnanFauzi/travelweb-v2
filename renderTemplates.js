                    ...
                    <div>
                        ...
                        <div class="space-y-1.5 mb-4">
                            <div class="flex items-center gap-2 text-[11px] text-muted-foreground font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#00A8B5" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>
                                <span>Katalog: <strong class="text-foreground">${item.category}</strong></span>
                            </div>
                            <div class="flex items-center gap-2 text-[11px] text-muted-foreground font-medium">
